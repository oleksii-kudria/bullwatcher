...
from config import (
    ...
    PRICE_NORM_DROP_THRESHOLD,
    RESULT_DIR,
    TELEGRAM_BOT_TOKEN,
    TELEGRAM_CHAT_ID,
    SELL_RSI_THRESHOLD,
    SELL_GROWTH_THRESHOLD,
    SELL_NORM_GROWTH_THRESHOLD,
...
def format_sector_reports(df):
    ...
    legend_message = (
        ...
        "- *Зміна* – приріст ціни за останні два місяці.\n"
        "- *норм* – порівняння середніх цін поточного та попереднього місяця; >0 – стійкий ріст, <0 – спад."
    )
